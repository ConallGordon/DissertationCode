...
```{r}
combo <- function(data, CoClustOutput, n = nrow(data), d = ncol(data)) {
...
```{r}
summary.clustCombo <- function(x, digits = getOption("digits"), ...) {
...
AttemptCombo = combo(CoClustOutput = output, data = filtered_matrix)
